...
function WhatsappButton({ text, styles }) {
  ...
  return (
    <a href="https://api.whatsapp.com/send?phone=3409330288&text=Hi, i would like to buy from here!." target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
